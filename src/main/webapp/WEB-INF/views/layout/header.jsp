...
<nav id="navbar" class="navbar navbar-expand-sm navbar-dark sticky-top" style="background-color: #F8F8FF; border-bottom: 1px solid gainsboro;">
	<div class="container ">
		<a href="/" style="font-weight: 900; font-family: system-ui;"> K01 - SHOP ĐIỆN TỬ <img src="https://raw.githubusercontent.com/TanhGL/1/main/logo-250.png" alt="" width="20%" style="margin-left: 20px;"></a>
		<div class="row" style="padding: 20px 15px 12px;">
			
			<div class="col-sm-6" style="padding-right: 15px;">
				<div class="input-group">
					<form action="/product/list-by-keywords" method="post">
						<input style="width: 240px" class="form-control" value="${param.keywords}" name="keywords" placeholder="Tìm kiếm sản phẩm" />
						<div class="input-group-append">
							<button class="btn btn-secondary" value="${param.keywords}" type="submit" style="background-color: rgb(25, 15, 119); border: none; width: 50px; height: 34px">
				...
				<div class="row">
					...
					<div class="col-sm-6">
						<div class="header-menu">
							<i class="fa fa-heartbeat" style="font-size: 30px; padding: 0px 5px 0px 5x ; color:#07436e"></i> 
								<a class="splike" href="/product/favo" style="color: #514748"> Sản phẩm yêu thích</a>
						</div>
					</div>
						...
						<div class="header-menu">
							<div class="card-hover" id="cart-img">
								<div class="card-sp">
									<ul>
										<li>
											<i class="fa fa-cart-plus" style="font-size: 30px; color:#07436e"></i>
											...
											<div class="tong-tien">
												...
												<br />
												<div>
													<a style="width: 320px" class="btn btn-primary"
