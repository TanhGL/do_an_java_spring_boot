						...
						<div class="row">
							<div class="col-sm-5">
								...
								<div class="product-image">
									<img src="/static/images/products/${prod.image}" title="${prod.name}">
								</div>
							</div>
							<div class="col-sm-7">
								<div class="san-pham-ct">
									...
									<br /> <a href="/product/detail/${prod.id}">
										<c:choose>
									...
									<p style="padding: 3px; font-size: 20px; font-weight: bold;">
										<c:choose>
											<c:when test="${prod.discount <= 0 }">
												<span style="text-align: left; font-weight: bold; color: red">
													<f:formatNumber value="${prod.unitPrice}" pattern="#,###" />VNĐ
												</span>
											</c:when>
											<c:otherwise>
												<span
										...
										<c:choose>
											<c:when test="${prod.discount > 0 }">
												<span style="margin-left: 1px; font-weight: bold; color: red">
													Giá khuyến mãi:
													<f:formatNumber value="${prod.unitPrice * (1 - prod.discount)}"
														pattern="#,###" /> VNĐ
												</span>
											</c:when>
											<c:otherwise>
									...
									<p>
										Tình trạng: <span
											style="background-color: #99FF99; border-radius: 4px; padding: 3px; color: black; font-weight: bold;">${prod.available?'Còn
											hàng':'Hết hàng'}</span>
									</p>

									<div class="row">
										<div class="col-sm-6" data-id="${prod.id}">
											<button class="theo-vao-gio btn-add-to-carts" data-toggle="modal"
												data-target="#myModals" style=" background-image: linear-gradient(-90deg, rgba(49, 20, 229, 1), rgb(21, 3, 3)) !important;"> <p style="font-family: monospace;
												margin-top: 6px; color: #fff;">THÊM VÀO GIỎ</p></button>
										</div>
								...
								<div class="sp-km">
									...
									<p>
										<img style="margin-top: -5px" src="/static/images/icon/icon_km.png" width="15px"
											height="15px">
					...
					<div class="ct2">
						...
						<div class="sp-km">
							...
							<i><i class="	far fa-check-circle ico"></i> &nbsp;Cam kết hàng
								...
								&nbsp;Miễn phí giao hàng từ 500K</i><br> <i><i class="fas fa-redo ico"></i> &nbsp;Đổi
								trả miễn phí trong 10 ngày</i> <br>
							<br>
							<h6>Dịch vụ khác</h6>
									...
									<div class="thumbnail">
										...
										<div class="caption">
											...
											<div data-id="${p.id}" class="pull-center text-center">
												<!-- icon thêm vào giỏ hàng ở index ( trang chủ của trang giao diện người dùng và người xem) -->
												<button class="btn btn-sm btn-danger btn-add-to-cart">
													<i class="glyphicon glyphicon-shopping-cart"></i>
												</button>
												<!-- icon thêm sản phẩm yêu thich ở index ( trang chủ của trang giao diện người dùng và người xem) -->
